#!/usr/bin/env python3
"""
Extract near-boundary samples for pairs (3,7) and (4,14), then run pytesseract on ~100 samples.
...
try:
    ...
    print("Also ensure tesseract-ocr is installed: sudo apt-get install tesseract-ocr tesseract-ocr-kor")
    sys.exit(1)
